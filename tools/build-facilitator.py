...
LEARNER_URL = "https://me5231979.github.io/Coaching-for-Performance/"
...
s = s.replace('<title>Coaching for Performance | Vanderbilt</title>',
              '<title>Coaching for Performance — Facilitator Edition | Vanderbilt</title>')
...
s = s.replace('Follow along on your own device. You will coach, be coached, and plan a real conversation. Everything you type stays on your screen.',
              'Learners scan this code and land on the learner edition; your screen keeps the notes. Every exercise is hands-on.')
...
s = s.replace('Coaching for Performance · A Vanderbilt learning experience',
              'Coaching for Performance · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">me5231979.github.io/Coaching-for-Performance</a>')
